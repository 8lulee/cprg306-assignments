  ...
  return (
    <div className="p-8 space-y-12">
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className="text-2xl mb-4">Count: {counter}</div>
        ...
        <div className="space-x-2">
          <button className="px-4 py-2 bg-blue-500 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed " disabled={disabled} onClick={() => setCounter(counter + 1)}>
            Increase
          </button>
          <button className="px-4 py-2 bg-red-500 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed" disabled={disabled} onClick={() => setCounter(counter - 1)}>
            Decrease
          </button>
        </div>
      </section>
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className={`p-6 rounded-lg ${theme === "light" ? "bg-slate-100 text-slate-900" : "bg-slate-800 text-slate-100"}`}>
        ...
        <button className="mt-4 px-4 py-2 bg-purple-500 text-white rounded" onClick={() => setTheme(theme === "light" ? "dark" : "light")}>
          Toggle Theme
        </button>
      </section>
      ...
      <section className="border p-6 rounded-lg">
        ...
        <div className="space-x-2 mb-4">
          <button className="px-4 py-2 bg-gray-500 text-white rounded" onClick={() => setFilteredProducts(products)}>
            All
          </button>
          <button className="px-4 py-2 bg-green-500 text-white rounded" onClick={() => setFilteredProducts(products.filter(p => p.category === "electronics"))}>
            Electronics
          </button>
          <button className="px-4 py-2 bg-green-500 text-white rounded" onClick={() => setFilteredProducts(products.filter(p => p.category === "furniture"))}>
            Furniture
          </button>
          <button className="px-4 py-2 bg-green-500 text-white rounded" onClick={() => setFilteredProducts(products.filter(p => p.category === "stationery"))}>
            Stationery
          </button>
        </div>
      ...
      <section className="border p-6 rounded-lg" >
        ...
        <button className="px-4 py-2 bg-indigo-500 text-white rounded mb-4" onClick={() => setShowDetails(!showDetails)}>
